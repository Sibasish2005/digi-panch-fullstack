    ...
    <section className="relative w-full bg-white py-24 px-6 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-6 gap-6">
          ...
          {/* AI CHATBOT */}
          <Link href="/chatbot" className="md:col-span-4 block">
            <motion.div
              whileHover={{ y: -4 }}
              transition={{ duration: 0.2 }}
              className="group relative h-full rounded-[32px] border border-white/20 bg-gradient-to-br from-slate-900 via-blue-900 to-cyan-800 p-8 text-white overflow-hidden"
            >
          ...
          {/* DOCUMENTS */}
          <Link href="/citizen/applications" className="md:col-span-2 block">
            <motion.div
              whileHover={{ y: -4 }}
              className="group h-full rounded-[32px] border border-slate-200 bg-white p-6 shadow-sm hover:shadow-xl transition-all"
            >
          ...
          {/* GRIEVANCE */}
          <Link href="/citizen/grievances" className="md:col-span-3 block">
            <motion.div
              whileHover={{ y: -4 }}
              className="group h-full rounded-[32px] bg-gradient-to-br from-red-500 to-orange-500 p-6 text-white overflow-hidden relative"
            >
          ...
          {/* PAYMENTS */}
          <Link href="/services" className="md:col-span-3 block">
            <motion.div
              whileHover={{ y: -4 }}
              className="group h-full rounded-[32px] border border-slate-200 bg-slate-50 p-6 overflow-hidden relative"
            >
